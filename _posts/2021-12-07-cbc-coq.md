...
1. **Validators** or **participating nodes** (Definition 2.1 from [minimal-cbc][1]: A non-empty set, $\mathcal{V}$
    ```coq
   validators : Type;
...
[1]: <https://github.com/cbc-casper/cbc-casper-paper/blob/master/cbc-casper-paper-draft.pdf> "Introducing the "Minimal CBC Casper" Family of Consensus Protocols"
